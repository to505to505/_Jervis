...
def upload_s3(photo_name, upload_path, s3folder):
    object_key = s3folder + photo_name
    with open(upload_path, "rb") as f:
        s3.upload_fileobj(f, bucket_name, object_key)

#EXAMPLE - Uploading file to s3 with name 'file_new.jpg' 
upload_s3('file_new.jpg', '/Users/dmitrysakharov/Documents/_Jervis/penis.jpg', 'reference/')

# Downloading the file from S3
def download_s3(photo_name, download_path, s3folder):
...
download_s3('file_new.jpg', '/Users/dmitrysakharov/Documents/_Jervis/telegram/app/reference/', 'reference/')
